...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/chembl_search \
  -H 'Content-Type: application/json' \
  -d '{"query":"aspirin"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/chembl_search`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
